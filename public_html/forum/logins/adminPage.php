...
<div class="secondPart templete clear">
            <div class="leftColum">
                ...
                <li><a href="/Forum/sort_questions/sort_interview_question.php">Update Questions</a></li>
                <li><a href="/Forum/classMeterials/addFile.php">Add New Zip File</a></li>
                <li><a href="/Forum/classMeterials/readFile.php">Class Materials</a></li>
                <li><a href="https://webmail.hostinger.com">Email</a></li>
                <li><a href="/Forum/logins/add_question.html">Add New Question</a></li>
                <li><a href="/Forum/questions/sorting/java_interview_question.php">Java Question</a></li>
                <li><a href="/Forum/questions/sorting/cucumber_interview_question.php">Cucumber Question</a></li>
                <li><a href="/Forum/questions/sorting/update_java_interview_question.php">Sort Java Question</a></li>
                <li><a href="/Forum/questions/sorting/update_cucumber_interview_question.php">Update Cucumber</a></li>
      ...
      <div class="left_pipe">
        ...
        Be Careful In Your Business Engine
    </div>
              <div class="top_left">
                  <ul>
